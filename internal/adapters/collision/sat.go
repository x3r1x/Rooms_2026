...
func checkAxes(points1, points2 []domain.Point, normals []domain.Point) bool {
...
func getMinMax(points []domain.Point, axis domain.Point) (float64, float64) {
	minimum := math.Inf(1)
	maximum := math.Inf(-1)
